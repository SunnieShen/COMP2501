...
survey_clean$no_employees <-
  factor(survey_clean$leave,levels = c("1-5", "6-25", "26-100", "100-500", "500-1000", "More than 1000"))
```
...
-   family_history: Those who have a family history of mental illness are around 35% more likely to get treatment rather than without a family history. This is aligns with thecommon snese that family history is a significant risk factor for many mental health disorders.

-   Work_interfere: 认为mental issue的工作的影响越大, 参与心理治疗的比例就越大

-   tech_company/ self_employed: 是否在科技公司工作, 是否远程办公 的治疗比例差距微小可以说明...?

-   Mental healthcare/ anonymity/ leave: 如果公司提供mental care 服务, 保证心里问题信息保密工作做得很好, 且在mental issue leave 程序上有保障, 那么更多的人愿意接受治疗
