...
-   Notice: "benefits", "care_options", "wellness_program", "seek_help" are all related to one perspectives regarding whether the employer has provided mental_care resources with different approach. We can combine them into one single variable "mental_care" (Yes/ No).
